...
{
	public List<ContentPage> lehed = new List<ContentPage>() { new TextPage(), new Figure() };
	public List<string> Tekstid = new List<string>{"Tee lahti TekstPage", "Tee lahti Figure"};
	ScrollView sv;
