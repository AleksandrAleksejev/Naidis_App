...
{
	public List<ContentPage> lehed = new List<ContentPage>() { new TextPage(0), new FigurePage(1), new Valgusfloor(), new DateTimePage(),  new Stepper_Slider() , new RGB(), new Lumememm(), new PickerImagePage() };
